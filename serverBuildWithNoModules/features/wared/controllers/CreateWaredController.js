...
const CreateWaredRepo_1 = __importDefault(require("../repos/CreateWaredRepo"));
    ...
    static store(req, res) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let filePathToStore = req.file
                ...
                : "";
            try {
                yield CreateWaredRepo_1.default.store(req.body, filePathToStore);
...
exports.default = CreateWaredController;
