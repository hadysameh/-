...
class WaredOptionsController {
    static getDaysBeforeExecution(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            let numOfDaysBeforeExecution = yield WaredOptionsController.getNumDaysBeforeExecution();
            res.json(numOfDaysBeforeExecution);
        });
    }
    static getNumDaysBeforeExecution() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return config === null || config === void 0 ? void 0 : config.getDataValue("daysBeforeExecution");
        });
    }
    static get(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
