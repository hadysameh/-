    ...
    (waredIdToEdit: FormData) => {
      axios
        ...
        .then((res) => {
          ...
          setType(data.type);
          let storedSelectedGehaa = {
            value: data.gehaa.id,
            label: data.gehaa.name,
          };
          console.log({ storedSelectedGehaa });
          setSelectedGehaa(storedSelectedGehaa);
          if (data.docDeadline) {
            setDeadLineDate(data.docDeadline);
            setHasDeadline(true);
          }
          ...
          const isWaredReferncingLastWared = data.lastWared?.id ? true : false;
          ...
          <button
            ...
            onClick={async () => {
              ...
              if (isReqFieldsFilled()) {
                ...
                await submitFormData(formData).then(() => {
